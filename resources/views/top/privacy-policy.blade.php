...
@section('title', 'プライバシーポリシー｜PayTech -ペイテック-')
@section('description', '『PayTech(ペイテック)』のプライバシーポリシーページになります。弊社のプライバシーポリシーをご紹介いたします。')

@push('head')
  <link rel="stylesheet" href="{{ template('css/privacy.css?33') }}">
  <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        "item": "paytech-factoring.com/"
        },
        {
          "@type": "ListItem",
          "position": 2,
          "name": "プライバシーポリシー",
          "item": "paytech-factoring.com/privacy-policy/"
        }
      ]
    }
  </script>
...
<main>
    <div class="section__privacy">
        <div class="container">
            <div id="breadcrumb">
                <a href="{{ route(lp().'home') }}">PAYTECH TOP</a>　>　<span class="breadcrumb_last" aria-current="page">プライバシーポリシー</span>
            </div>

            <h1 class="title-public">プライバシーポリシー</h1>
            <div class="page-content">
                <p>PayTech-ペイテック-（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
                </p>

                <p class="title-two">第1条（個人情報）</p>
                ...
                <p class="title-two">第2条（個人情報の収集方法）</p>
                ...
                <p class="title-two">第3条（個人情報を収集・利用する目的）</p>
                ...
                <p class="title-two">第4条（利用目的の変更）</p>
                <ol>
                    <li>当社は，利用目的が変更前と関連性を有すると合理的に認められる場合に限り，個人情報の利用目的を変更するものとします。</li>
                    <li>利用目的の変更を行った場合には，変更後の目的について，当社所定の方法により，ユーザーに通知し，または本ウェブサイト上に公表するものとします。</li>
                </ol>

                <p class="title-two">第5条（個人情報の第三者提供）</p>
                <ol>
                ...
                <p class="title-two">第6条（個人情報の開示）</p>
                <ol>
                ...
                <p class="title-two">第7条（個人情報の訂正および削除）</p>
                <ol>
                ...
                <p class="title-two">第8条（個人情報の利用停止等）</p>
                <ol>
                ...
                <p class="title-two">第9条（プライバシーポリシーの変更）</p>
                <ol>
                    <li>本ポリシーの内容は，法令その他本ポリシーに別段の定めのある事項を除いて，ユーザーに通知することなく，変更することができるものとします。</li>
                    <li>当社が別途定める場合を除いて，変更後のプライバシーポリシーは，本ウェブサイトに掲載したときから効力を生じるものとします。</li>
                </ol>

                <p class="title-two">第10条（お問い合わせ窓口）</p>
                ...
                <p>
                    <strong>
                        ...
                        電話番号：<a href="tel:03-5830-6464">03-5830-6464</a><br>
                        営業時間：9：00〜18：00<br>
                        定休日：土日・祝日
                    </strong>
                </p>
